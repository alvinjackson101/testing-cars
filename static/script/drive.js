...
function turnIt(classes, direction, cmd) {
    ...
    switch(direction) {
        case NORTH:
            if(cmd == RIGHT) {
                newClasses = classes.replace("north", "east")
            }
            else if (cmd == LEFT) {
                newClasses = classes.replace("north", "west");
            }
            break;
        case SOUTH:
            if(cmd == RIGHT) {
                newClasses = classes.replace("south", "west");
            }
            else if (cmd == LEFT) {
                newClasses = classes.replace("south", "east");
            }
            break;
        case EAST:
            if(cmd == RIGHT) {
                newClasses = classes.replace("east", "south");
            }
            else if (cmd == LEFT) {
                newClasses = classes.replace("east", "north");
            }
            break;
        case WEST:
            if(cmd == RIGHT) {
                newClasses = classes.replace("west", "north");
            }
            else if (cmd == LEFT) {
                newClasses = classes.replace("west", "south");
            }
            break;
    }
